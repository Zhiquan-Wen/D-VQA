...
class LXRTEncoder(nn.Module):
    ...
    def load(self, path):
        ...
        # state_dict = torch.load('/mnt/cephfs/home/wenzhiquan/code_2020/Debias/lxmert/src/snap/pretrained/model_LXRT.pth')
        state_dict = torch.load('/mnt/cephfs/home/wenzhiquan/code_2020/Debias/lxmert/src/Epoch20_LXRT.pth')
        new_state_dict = {}
