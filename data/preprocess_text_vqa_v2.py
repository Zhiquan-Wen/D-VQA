...
if __name__ == '__main__':
    ...
    compute_target_for_testing(val_answers, ans2label, 'val', target_root)
    ...
    #     ans2label = cPickle.load(open(cache_path, 'rb'))
    # else:
    #     ans2label = create_ans2label(occurence, 'train_val_without_val', args.dataroot +'cache')

    # target_root = args.dataroot +'cache'

    # compute_target(train_answers, ans2label, 'train_without_val_ans', target_root)
    # compute_target(val_answers, ans2label, 'val_without_val_ans', target_root)
    # compute_target_for_testing(val_answers, ans2label, 'val', target_root)
