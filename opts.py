...
def parse_opt():
    ...
    parser.add_argument('--tao', type=float, default=1.0, help='tao for contrastive loss')
    parser.add_argument('--contrast', type=float, default=1.0, help='weight of the contrastive loss')
    parser.add_argument('--self_loss_q', type=float, default=0.7, help='relative weight of negative q')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.001,
                    help='learning rate')
    # follow SSL-VQA, we set the self-loss weight for 3
